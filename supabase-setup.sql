...
INSERT INTO public.students (
  user_id, name, email, phone, birth_date, gender, 
  address, emergency_contact, emergency_phone, medical_notes
) VALUES (
  auth.uid(),
  'João Silva',
  ...
  'Maria Silva',
  '(11) 88888-8888',
  'Nenhuma restrição médica conhecida'
);

-- Exemplo de teste de performance
INSERT INTO public.performance_tests (
  student_id, user_id, test_date, test_type,
  weight, height, vo2_max, cooper_test_distance
) VALUES (
